...
const EditHpaMain = () => {
  ...
  const [store, dispatch] = useStore(
    (state) => state?.app?.projectManagement?.hpa?.detail
  );
  ...
  return (
    <div className="element-wrapper">
      <Row>
        <div className="border shadow-sm d-flex justify-content-between">
          <div className="p-2">
            <h5 className="fw-bold m-0 text-black">Edit Config Map</h5>
          </div>
          ...
          <Row>
            ...
            <Col>
              <Form.Group className="mb-1" controlId="workload">
                ...
                <Form.Select
                  aria-label="Default select example"
                  defaultValue={store?.targetWorkload}
                >
                  <option>Placeholder</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
          ...
          <Row>
            <Col>
              <Form.Group className="mb-1" controlId="minReplicas">
                ...
                <Form.Control
                  defaultValue={store?.minReplicas}
                  placeholder="Placeholder"
                  type="text" />
              </Form.Group>
            </Col>
            <Col>
              <Form.Group className="mb-1" controlId="minReplicas">
                ...
                <Form.Control
                  defaultValue={store?.maxReplicas}
                  placeholder="Placeholder"
                  type="text" />
              </Form.Group>
            </Col>
...
EditHpaMain.displayName = 'EditHpaMain';
export { EditHpaMain };
