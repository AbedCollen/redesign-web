...
const DeploymentDetailMain = () => {
  ...
  return (
    <div className="p-2 mx-2 element-wrapper">
      <h5 className="fw-bold text-black mb-2">Deployment Detail</h5>
          ...
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              <Row className="mb-1">
                ...
                <Col>
                  <NxFormControl
                    label="Use Host’s Network Namespaces"
                    readOnly={true}
...
DeploymentDetailMain.displayName = 'DeploymentMain';
export { DeploymentDetailMain };
