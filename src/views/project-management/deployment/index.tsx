...
const DeploymentMain = () => {
  ...
  return (
    <div className="p-2 element-wrapper">
      <h4 className="fw-bold mb-2 text-black">Deployment</h4>
      <div className="rounded border p-1">
        <Row className="mb-1">
          ...
          <Col className="d-flex justify-content-end">
            <Button className="d-flex align-items-center gap-50" href={allRoutes.projectManagement.deploymentAdd}>
              <Plus size={16} />
              Deployment
            </Button>
          </Col>
...
DeploymentMain.displayName = 'DeploymentMain';
export { DeploymentMain };
