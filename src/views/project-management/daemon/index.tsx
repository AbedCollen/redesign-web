...
const DaemonMain = () => {
  ...
  return (
    <div className="p-2 element-wrapper">
      <h4 className="fw-bold mb-2 text-black">DaemonSet</h4>
      <div className="rounded border p-1">
        <Row className="mb-1">
          ...
          <Col className="d-flex justify-content-end">
            <Button className="d-flex align-items-center gap-50" href={allRoutes.projectManagement.daemonAdd}>
              <Plus size={16} />
              DaemonSet
            </Button>
          </Col>
...
DaemonMain.displayName = 'DaemonMain';
export { DaemonMain };
