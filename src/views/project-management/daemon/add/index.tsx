...
const DaemonAddMain = () => {
  return (
    <div>
      <div className="p-2 mb-2 d-flex shadow-sm bg-white rounded">
        <Col>
        <h5 className="fw-bold text-black">Add DaemonSet</h5>
        </Col>
        <Col className="text-end">
          <div className="d-flex align-items-center justify-content-end gap-75">
            <Button
              className="d-flex align-items-center gap-50"
              href={allRoutes.projectManagement.daemon}
              variant="outline-danger"
            >
              <X size={20} /> Cancel
            </Button>

            <Button href="#" className="d-flex align-items-center gap-50">
...
DaemonAddMain.displayName = 'DaemonAddMain';
export { DaemonAddMain };
