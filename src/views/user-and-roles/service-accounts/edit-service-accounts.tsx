...
const EditServiceAccountsMain = () => {
  ...
  Partial<ServiceAccountsDataModel> | undefined
  >(store);
  ...
  return (
    <div className="element-wrapper">
      <Row className="p-2 shadow-sm">
        <Col>
          <h5 className="fw-bold text-black">Edit Service Account Form</h5>
        </Col>
        <Col>
          ...
          <Row>
            ...
            <Col>
              <NxFormControl
                label="Namespace"
                placeholder="Placeholder"
                value={stateData?.labels || ''}
                onChange={(e) => handleChange(e.target.value, 'labels')} />
            </Col>
          </Row>
          <Row className="mt-1">
            <Col>
...
EditServiceAccountsMain.displayName = 'EditServiceAccountsMain';
export { EditServiceAccountsMain };
