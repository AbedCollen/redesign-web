...
import type { SearchingDataModel } from '@models/app/logs/searching/types';
...
const tableColumns = (
  ...
  {
    cell: (row) => {
      return <div className="w-75 py-1">{JSON.stringify(row.body)}</div>;
    },
    grow: 1,
    name: 'Body'
  }
      ...
      return (
        <div className="d-flex py-1 align-items-center">
          <div className="border rounded p-1">
            ...
            <div className="col d-flex gap-1 border-top pt-1">
              <Button
