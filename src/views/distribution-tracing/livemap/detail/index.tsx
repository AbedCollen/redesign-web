...
import { CustomNodesDetail } from './custom-nodes-detail';
import { DATA_LIVE_MAP_DETAIL } from '../constants';
...
const initialNodes = DATA_LIVE_MAP_DETAIL.map((dataItem, index) => ({
  data: {
    label: (
      <CustomNodesDetail
...
LiveMapDetail.displayName = 'LiveMapDetail';
export { LiveMapDetail };
