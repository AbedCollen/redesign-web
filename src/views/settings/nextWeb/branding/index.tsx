...
const NextWebBranding = () => {
  const [store, dispatch] = useStore(
    (state) => state?.app?.settings?.nextWebBranding?.main
  );
  ...
  useEffect(() => {
    dispatch(StoreCommand.app.settings.nextWebBranding.GetMainData());
  }, [dispatch]);
    ...
    <div className="element-wrapper">
      <div className="d-flex justify-content-between align-items-center mb-2 shadow-sm p-2">
        ...
        <Button
          ...
          href={allRoutes.settings.addNextWebBranding}
        >
          <Plus size={16} />
          Branding
        </Button>
...
NextWebBranding.displayName = 'NextWebBranding';
export { NextWebBranding };
