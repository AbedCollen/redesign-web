...
const NextIDBranding = () => {
  const [store, dispatch] = useStore(
    (state) => state?.app?.settings?.nextIDBranding?.main
  );
  ...
  useEffect(() => {
    dispatch(StoreCommand.app.settings.nextIDBranding.GetMainData());
  }, [dispatch]);
    ...
    <div className="element-wrapper">
      <div className="d-flex justify-content-between align-items-center mb-2 shadow-sm p-2">
        ...
        <Button
          ...
          href={allRoutes.settings.addNextIDBranding}
        >
          <Plus size={16} />
          Branding
        </Button>
...
NextIDBranding.displayName = 'NextIDBranding';
export { NextIDBranding };
